...
insert into dict_notify_type (name, caption)
values ('system', 'Система'),
       ('comment', 'Комментарий'),
       ('task', 'Задача');

insert into dict_task_status (name, caption)
values ('new', 'New task');
insert into _user_credits
values (getnextid(), 'autotest_user', '$2a$10$8vzgsIktNcMSE1/QU49jVeO1dVo2sJFFdHncZbN.QAFEhXovqSJA6', 'jopa@mail.ru');
insert into _user (login, name)
values ('autotest_user', 'main buddy');
